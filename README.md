...
- 멘토 즐겨찾기와 멘토별 일정 보기
- 데이터 갱신 시 직전 대비 변경점(신규·취소·마감·마감 임박·신청자 수) 안내
...
- 변경 요약 배너: 새 일정 / 취소 / 마감 전환 / 마감 임박 / 신청자 수 변동을 종류별로 묶어 보여줍니다. 항목을 누르면 해당 일정 상세로 이동합니다.
- 내가 신청했거나 관심 표시한 일정이 바뀌면 위쪽에 먼저 강조됩니다.
